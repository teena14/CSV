...
export default function Home() {
  ...
  const reset = useCallback(() => {
    ...
    setBatchesDone(0);
    setTotalBatches(1);
  }, [setBatchesDone, setTotalBatches]);
      ...
      <main className="app-main">
        ...
        {error && (
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontWeight: 600, marginBottom: 2, fontSize: 'var(--text-sm)' }}>
                Error
              </div>
        ...
        {step === 'results' && result && preview && (
          <ResultsTable result={result} filename={preview.filename} onReset={reset} />
        )}
      </main>

      {/* Footer */}
      <footer className="app-footer">GrowEasy CRM · AI-Powered CSV Importer</footer>
    </div>
  );
}
